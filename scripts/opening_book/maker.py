...
may_ply = 10 # fél-lépések (10 = 5 teljes lépés)
engine_time = 5
multipy = 3

# FEN szelekció szabályok
max_total_fens = 100_000
min_frequency = 10   # ritka folytatások kidobása

random_seed = 664656540174585650750794237549 # Ez "véletlenül" egy 30 számjegyű prím
